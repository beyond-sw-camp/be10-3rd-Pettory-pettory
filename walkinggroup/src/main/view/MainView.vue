<template>
  <div class="main-page">
    <!-- 제목 부분 -->
    <h1>반려동물과 함께 만들어 가는 나의 이야기, 펫토리</h1>

    <!-- 산책 모임 -->
    <div class="meetup-section">
      <img src="@/common/image/펫토리아이콘.png" alt="모임 이미지" class="meetup-image" />
    ...
    <div class="buy-section">
      <div class="buy-content">
        <h2>주변 사람들과 함께 물건 구매하기</h2>
        <p>주변 사람들과 함께 나의 반려동물을 위한 물건을 구매해보세요</p>
      ...
      <img src="@/common/image/펫토리아이콘.png" alt="모임 이미지" class="buy-image" />

    </div>

    <!-- 게시판 -->
    <div class="board-section">
      <img src="@/common/image/펫토리아이콘.png" alt="모임 이미지" class="board-image" />
    ...
    <div class="counseling-section">
      <div class="counseling-content">
        <h2>나의 반려동물에 대한 고민이 있다면?</h2>
        <p>질문을 남겨보세요 수의사들이 직접 답변해줍니다</p>
      ...
      <img src="@/common/image/펫토리아이콘.png" alt="모임 이미지" class="counseling-image" />
...
.counseling-button button:hover {
  background-color: #55bbbb;
}
