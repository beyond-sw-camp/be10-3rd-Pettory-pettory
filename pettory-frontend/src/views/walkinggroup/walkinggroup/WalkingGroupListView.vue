...
import SearchBar from "@/components/walkinggroup/common/SearchBar.vue";
import WalkingGroupList from "@/components/walkinggroup/walkinggroup/WalkingGroupList.vue";
