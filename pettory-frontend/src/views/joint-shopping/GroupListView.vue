...
import SearchBar from "@/components/joint-shopping/shopping-group-list/SearchBar.vue";
import GroupList from "@/components/joint-shopping/shopping-group-list/GroupList.vue";
