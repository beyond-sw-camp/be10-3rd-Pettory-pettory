...
import CategoryItem from '@/components/counseling/category/CategoryItem.vue';
import CreateCategoryModal from "@/components/counseling/category/CreateCategoryModal.vue";
import DeleteCategoryModal from "@/components/counseling/category/DeleteCategoryModal.vue";
import UpdateCategoryModal from "@/components/counseling/category/UpdateCategoryModal.vue";
import CategoryButton from "@/components/counseling/category/CategoryButton.vue"; // 로직 가져오기
import { useCategoryLogic } from '@/components/counseling/category/CategoryListLogic.vue';
